...
> *Earlier in this chapter, [How Coding Agents Work](how-agents-work.md) showed you the agent loop: read context → plan → act → observe → repeat. The quality of that loop depends almost entirely on the "read context" step. Get context right, and agents produce remarkable work. Get it wrong, and no amount of prompting will save you.*
