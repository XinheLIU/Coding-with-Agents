...
这套 FAANG 工作流在个人层面已经有效；到了团队层面，它会从“好习惯”升级为“工程系统”。当多人同时使用多个智能体时，真正的挑战不再是单次提示词怎么写，而是如何维护共享上下文、统一工程规范、建立验证闭环。第四章会从这个问题展开：[为什么团队级开发更需要工程化](../04-team/why-team-level-development-is-harder.md)。
